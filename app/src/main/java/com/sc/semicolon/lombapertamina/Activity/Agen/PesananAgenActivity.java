...
public class PesananAgenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pesanan_agen);
        initView();
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()){
                    try {
                        ...
                        if (jsonArray == null){
                            Toast.makeText(PesananAgenActivity.this, "data Transaksi kosong", Toast.LENGTH_SHORT).show();
                        }else {
                            for (int i = 0; i <jsonArray.length() ; i++) {
                                ...
                                if (shared.getSpIdAgen().equals(id_agen) && status_pesan.equals("KIRIM")){
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            apiService1.updateStatus(idTrans.getText().toString(),"DISETUJUI").enqueue(new Callback<ResponseBody>() {
                                                ...
                                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                    ...
                                                    if (response.isSuccessful()){
                                                        try {
                                                            ...
                                                            Toast.makeText(PesananAgenActivity.this, ""+pesan, Toast.LENGTH_SHORT).show();
                                                ...
                                                public void onFailure(Call<ResponseBody> call, Throwable t) {
                                                    pd.dismiss();
                                                    Toast.makeText(PesananAgenActivity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        }
                                    });
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            apiService2.updateStatus(idTrans.getText().toString(),"DIBATALKAN").enqueue(new Callback<ResponseBody>() {
                                                ...
                                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                    ...
                                                    dialog = new AlertDialog.Builder(PesananAgenActivity.this);
...
//                                    Toast.makeText(PesananUserActivity.this, "data pesan kosong login dahulu", Toast.LENGTH_SHORT).show();
    ...
    private void permissionFile() {
        if (ContextCompat.checkSelfPermission(PesananAgenActivity.this,
                Manifest.permission.SEND_SMS)
                != PackageManager.PERMISSION_GRANTED) {
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(PesananAgenActivity.this,
                    Manifest.permission.SEND_SMS)) {
                ...
                ActivityCompat.requestPermissions(PesananAgenActivity.this,
