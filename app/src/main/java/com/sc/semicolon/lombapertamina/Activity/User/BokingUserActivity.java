...
public class BokingUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_boking_user);
        initView();
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                if (response.isSuccessful()){
                    try {
                        ...
                        if (jsonArray == null){
                            Toast.makeText(BokingUserActivity.this, "data Transaksi kosong", Toast.LENGTH_SHORT).show();
                        }else {
                            for (int i = 0; i <jsonArray.length() ; i++) {
                                ...
                                final String pesan = jsonObject.optString("status");

                                if (shared.getSpIdUser().equals(id_user) && status_pesan.equals("BOKING")){
                                    ...
                                    final TextView idTansaksi = addview.findViewById(R.id.txt_id_transaksi);
                                    ...
                                    idTansaksi.setText(id_transaksi);
                                    ...
                                    button.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            apiService1.updateStatus(idTansaksi.getText().toString(),"SAMPAI").enqueue(new Callback<ResponseBody>() {
                                                @Override
                                                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                                    if (response.isSuccessful()){
                                                        try {
                                                            ...
                                                            Toast.makeText(BokingUserActivity.this, ""+pesan, Toast.LENGTH_SHORT).show();
                                                ...
                                                public void onFailure(Call<ResponseBody> call, Throwable t) {
                                                    Toast.makeText(BokingUserActivity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                        }
                                    });
...
//                                    Toast.makeText(BokingUserActivity.this, "data boking kosong login dahulu", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    } catch (JSONException e) {
